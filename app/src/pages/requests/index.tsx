        ...
        <CardBox className="mb-6" hasTable>
            <Table
              columns={[
                ...
                { key: 'startDate', label: 'Fecha de inicio', type: 'custom', render: (row: Request) => formatDate(row.startDate) }, // Formatear fecha de inicio
                { key: 'endDate', label: 'Fecha de fin', type: 'custom', render: (row: Request) => formatDate(row.endDate) }, // Formatear fecha de fin
